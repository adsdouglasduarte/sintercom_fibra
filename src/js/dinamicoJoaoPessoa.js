class TesteJpessoa extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <!-- Navbar principal -->
      <nav class="nav__geral navbar navbar-expand-lg navbar-light bg-light px-3 fixed-top shadow-sm">
        <div class="container-fluid">
          <a class="navbar-brand fw-bold text-primary" href="#">Sintercom PB</a>
      ...
      <!-- Conteúdo principal -->
      <main class="conteudo__geral--jpessoa">
...
customElements.define("teste-joaopessoa", TesteJpessoa);
