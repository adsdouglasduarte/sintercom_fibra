class TesteVitoria extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <!-- Navbar principal -->
      <nav class="nav__geral navbar navbar-expand-lg navbar-light bg-light px-3 fixed-top shadow-sm">
        <div class="container-fluid">
          <a class="navbar-brand fw-bold text-primary" href="#">Sintercom ES</a>
      ...
      <!-- Conteúdo principal -->
      <main class="conteudo__geral--vitoria">
...
customElements.define("teste-vitoria", TesteVitoria);
